...
function plrWiki_myfunction() { 
    ...
    wp_register_script ( 'plr-funops' , plugins_url('/js/modules/funops.js', __FILE__) , array('jquery')); // this last part-( array('jquery') )is added in case your script needs to be included after jquery
    wp_localize_script( 'plr-funops', 'plrAjax', array( 'ajaxurl' => admin_url( 'admin-ajax.php' )));  
    wp_enqueue_script ( 'plr-funops', plugins_url('/js/modules/funops.js', __FILE__) , array('jquery'), '1.3', true  ); // then print. it will be added after jquery is added
